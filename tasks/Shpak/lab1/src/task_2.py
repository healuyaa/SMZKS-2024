...
M_lst = invert_element(M_lst, 5)  # Инверсия бита в позиции 5 (для моделирования ошибки)
M_lst = invert_element(M_lst, 3)  # Инверсия бита в позиции 3 (вторая ошибка)
